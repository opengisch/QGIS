...
class CORE_EXPORT QgsLayoutItemScaleBar: public QgsLayoutItem
{
  ...
  public:
     ...
     */
    QGIS_DEPRECATED QFont font() const SIP_DEPRECATED;
     ...
     * \deprecated use textFormat() instead
     */
    QGIS_DEPRECATED QColor fontColor() const SIP_DEPRECATED;
     ...
     * \deprecated use setTextFormat() instead
     */
    QGIS_DEPRECATED void setFontColor( const QColor &color ) SIP_DEPRECATED;
